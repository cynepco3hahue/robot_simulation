...
# This function makes the robot with the given id move along a track with a ~25cm part of a straight line,
# and a circular part with radius ~10cm. All time and speed calculations are done empirically. 
